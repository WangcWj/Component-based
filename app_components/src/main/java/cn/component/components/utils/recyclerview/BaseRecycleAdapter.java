...
import cn.component.components.utils.click.FilterClickListener;
import cn.component.components.utils.click.ItemClickListener;
import cn.screen.adaptation.app_components.R;
...
public abstract class BaseRecycleAdapter<T> extends RecyclerView.Adapter<BaseViewHolder> {
    ...
    public void onBindViewHolder(BaseViewHolder holder, int position) {
        ...
        if (null != itemView) {
            ...
            itemView.setOnClickListener(new FilterClickListener() {
                @Override
