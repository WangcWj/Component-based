package com.chanven.lib.cptr.header.progressheader;
...
public class DefaultHeaderView extends BaseHeaderView {
    ...
    public void setProgressWhiteStyle() {
        mRotateView.setBackgroundResource(R.drawable.icon_down_white);
        mProgressBar.setIndeterminateDrawable(ContextCompat.getDrawable(getContext(), R.drawable.progress_bar_white));
