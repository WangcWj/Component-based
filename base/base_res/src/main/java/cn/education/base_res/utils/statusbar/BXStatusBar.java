package cn.education.base_res.utils.statusbar;
...
public class BXStatusBar {
    ...
    public static void setImmersiveStatusBar(Activity activity,View needOffset){
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.KITKAT) {
            return;
        }
        setTransparentForWindow(activity);
    ...
    private static void adapterViewMargin(View view,Activity activity){
